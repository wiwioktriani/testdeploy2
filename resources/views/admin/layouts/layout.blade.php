                ...
                <div class="notification-box ml-15 d-none d-md-flex">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notification">
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src={{ asset('admin_asset/images/lead/lead-6.png') }} alt="" />
                        </div>
                        <div class="content">
                          <h6>
                            John Doe
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src={{ asset('admin_asset/images/lead/lead-1.png') }} alt="" />
                        </div>
                        <div class="content">
                          <h6>
                            Jonathon
                ...
                <div class="header-message-box ml-15 d-none d-md-flex">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="message">
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src={{ asset('admin_asset/images/lead/lead-5.png') }} alt="" />
                        </div>
                        <div class="content">
                          <h6>Jacob Jones</h6>
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src={{ asset('admin_asset/images/lead/lead-3.png') }} alt="" />
                        </div>
                        <div class="content">
                          <h6>John Doe</h6>
                ...
                <div class="profile-box ml-15">
                  <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                    ...
                    <div class="profile-info">
                      <div class="info">
                        <div class="image">
                          <img src={{ asset('admin_asset/images/profile/profile-image.png') }} alt="" />
                        </div>
                        <div>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    <li>
                      <div class="author-info flex items-center !p-1">
                        <div class="image">
                          <img src={{ asset('admin_asset/images/profile/profile-image.png') }} alt="image">
                        </div>
                        <div class="content">
