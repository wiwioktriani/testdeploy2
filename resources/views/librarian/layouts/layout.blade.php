  ...
  <body>
    ...
    <aside class="sidebar-nav-wrapper">
      ...
      <nav class="sidebar-nav">
        <ul>
          <li class="nav-item nav-item-has-children" {{request()->routeIs('librarian')||request()->routeIs('librarian.order.history')?'active' : ''}}>
            <a
              href="#0"
            ...
            <ul id="ddmenu_1" class="collapse {{request()->routeIs('librarian')||request()->routeIs('librarian.order.history')?'show' : ''}} dropdown-nav">
              <li>
          ...
          <li class="nav-item nav-item-has-children" {{ request()->routeIs('librarian.store') || request()->routeIs('librarian.store.manage') ? 'active' : '' }}>
            <a
              href="#0"
            ...
            <ul id="ddmenu_2" class="collapse {{ request()->routeIs('librarian.store') || request()->routeIs('librarian.store.manage') ? 'show' : '' }} dropdown-nav">
              <li>
          ...
          <li class="nav-item nav-item-has-children" {{ request()->routeIs('librarian.product') || request()->routeIs('librarian.product.manage') ? 'active' : '' }}>
            <a
              href="#0"
            ...
            <ul id="ddmenu_2" class="collapse {{ request()->routeIs('librarian.product') || request()->routeIs('librarian.product.manage') ? 'show' : '' }} dropdown-nav">
              <li>
